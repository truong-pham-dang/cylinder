        ...
        if(c2 < 0) then
          if(TypeBC(c2).eq.WALLFL) then
            ...
            if(Rad_2 < Rad_1(i) .and. Rad_2 > Rad_1(i+1).and.zc(c1) < 0.1) then
              ...
              Ump(i)   = Ump(i) + (U % n(c1) * U % n(c1)            &
              + V % n(c1) * V % n(c1) + W % n(c1)*W % n(c1))**0.5 
              Wmp(i)   = Wmp(i) + W % n(c1)
      ...
      do c = 1, NC
        ...
        if(Rad_2 < Rad_1(i) .and. Rad_2 > Rad_1(i+1)) then
          ...
          if(zc(c) < 0.0284.and.zc(c) > 0.0236)then
            ...
            wwp1(i)   = wwp1(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp1(i)   = uwp1(i) + (uw % mean(c)- Urad_mean * W % n(c))
          ...
          if(zc(c) < 0.109.and.zc(c) > 0.0956)then
            ...
            wwp2(i)   = wwp2(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp2(i)   = uwp2(i) + (uw % mean(c)- Urad_mean * W % n(c))
          end if
          if(zc(c) < 0.5517.and.zc(c) > 0.4893)then
            ...
            wwp3(i)   = wwp3(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp3(i)   = uwp3(i) + (uw % mean(c)- Urad_mean * W % n(c))
          end if
          if(zc(c) < 1.0.and.zc(c) > 0.8883)then
            ...
            wwp4(i)   = wwp4(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp4(i)   = uwp4(i) + (uw % mean(c)- Urad_mean * W % n(c))
          end if
          if(zc(c) < 2.0.and.zc(c) > 0.1875000E+01)then
            ...
            wwp5(i)   = wwp5(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp5(i)   = uwp5(i) + (uw % mean(c)- Urad_mean * W % n(c))
          end if
          if(zc(c) < 3.0.and.zc(c) > 2.875)then
            ...
            wwp6(i)   = wwp6(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp6(i)   = uwp6(i) + (uw % mean(c)- Urad_mean * W % n(c))
          end if
          if(zc(c) < 4.0.and.zc(c) > 3.875)then
            ...
            wwp7(i)   = wwp7(i) + (ww % mean(c)- W % n(c) * W % n(c))
            uwp7(i)   = uwp7(i) + (uw % mean(c)- Urad_mean * W % n(c))
          end if
        end if
      end do 
