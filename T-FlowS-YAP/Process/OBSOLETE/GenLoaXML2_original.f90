...
!--scalar: alpha field
if ((SIMULA == HYB_ZETA).and.(ZETA_ALPHA==YES)) then
...
if ((SIMULA == HYB_ZETA).and.(HYB_ZETA_VISC==YES)) then
...
if (((SIMULA == HYB_ZETA).and.(STATISTICS_ON == YES).and.(HYB_ZETA_KLES==YES)).or.SIMULA==ZPANS) then
...
if ( (RE_STRESS_ON == YES).and.(STATISTICS_ON == YES) ) then
                                   ...
                                   if (connessione(n,9) /= 0) then
                                     do i=2,9
                                       ...
                                       if ((connessione(n,8) == 0).and.(connessione(n,7) /= 0)) then
                                         write(9,*) connessione(n,2)-1, connessione(n,4)-1, connessione(n,3)-1, connessione(n,5)-1, connessione(n,7)-1, connessione(n,6)-1
                                       else
                                          if ((connessione(n,7) == 0).and.(connessione(n,6) /= 0)) then
                                              write(9,*) connessione(n,5)-1, connessione(n,4)-1, connessione(n,3)-1, connessione(n,6)-1, connessione(n,2)-1
                                          else
                                              write(9,*) connessione(n,5)-1, connessione(n,4)-1, connessione(n,3)-1, connessione(n,2)-1
                                          end if
                                       end if
                                   end if
