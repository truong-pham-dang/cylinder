...
!--------------------------------[CVS]---------------------------------*
  ...
  data rcs1/ &
  '$Id: A2B.f90,v 1.5 2002/10/31 11:26:57 niceno Exp $'/
  data rcs2/ &
  '$Source: /home/IUS/mhadziabdic/.CVSROOT/T-Rex/Test/A2B.f90,v $'/
!======================================================================*
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*
!     Writing the binary file with the      *
!        connections between cells         *
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*
  namOut = name 
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*
  ...
  read(9,'(E24.16)') (xc(c), c=1,NC)
  read(9,'(E24.16)') (yc(c), c=1,NC) 
  read(9,'(E24.16)') (zc(c), c=1,NC)
  read(9,'(E24.16)') (xc(c), c=-1,-NBC,-1)  
  read(9,'(E24.16)') (yc(c), c=-1,-NBC,-1)
  read(9,'(E24.16)') (zc(c), c=-1,-NBC,-1) 
  read(9,'(E24.16)') (volume(c), c=1,NC)
  read(9,'(E24.16)') (delta(c), c=1,NC)
  read(9,'(E24.16)') (WallDs(c), c=1,NC)
  read(9,'(E24.16)') (Sx(s), s=1,NS)
  read(9,'(E24.16)') (Sy(s), s=1,NS)
  read(9,'(E24.16)') (Sz(s), s=1,NS)
  read(9,'(E24.16)') (Dx(s), s=1,NS)
  read(9,'(E24.16)') (Dy(s), s=1,NS)
  read(9,'(E24.16)') (Dz(s), s=1,NS)
  read(9,'(E24.16)') (f(s), s=1,NS)
  read(9,'(E24.16)') (xsp(s), s=1,NS)
  read(9,'(E24.16)') (ysp(s), s=1,NS)
  read(9,'(E24.16)') (zsp(s), s=1,NS)

  close(9) 

!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*
!     Write the binary file with     *
!       geometrical quantities      *
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*
  namOut = name 
  ...
  write(9) (yc(c), c=1,NC) 
  write(9) (zc(c), c=1,NC)
  write(9) (xc(c), c=-1,-NBC,-1)  
  write(9) (yc(c), c=-1,-NBC,-1)
  write(9) (zc(c), c=-1,-NBC,-1) 
  write(9) (volume(c), c=1,NC)
  write(9) (delta(c), c=1,NC)
  write(9) (WallDs(c), c=1,NC)
  write(9) (Sx(s), s=1,NS)
  write(9) (Sy(s), s=1,NS)
  write(9) (Sz(s), s=1,NS)
  write(9) (Dx(s), s=1,NS)
  ...
  write(9) (Dz(s), s=1,NS)
  write(9) (f(s), s=1,NS)
  write(9) (xsp(s), s=1,NS)
  write(9) (ysp(s), s=1,NS)
  write(9) (zsp(s), s=1,NS)
