...
!--scalar: alpha field
  ...
  write(9,'(A)') '        <DataArray type="Float32" Name="Kin_mean" format="ascii">'
                             do c=1,NCsub
                                write(9,*) Kin % mean(c)
                             end do
  write(9,'(A)') '        </DataArray>'

  write(9,'(A)') '        <DataArray type="Float32" Name="Eps_mean" format="ascii">'
                             do c=1,NCsub
                                write(9,*) Eps % mean(c)
                             end do
  write(9,'(A)') '        </DataArray>'

  write(9,'(A)') '        <DataArray type="Float32" Name="LRANS" format="ascii">'
                             do c=1,NCsub
                                write(9,*) (Kin % mean(c)**1.5) / Eps % mean(c)
                             end do
  write(9,'(A)') '        </DataArray>'

  write(9,'(A)') '        <DataArray type="Float32" Name="LSGS" format="ascii">'
                             do c=1,NCsub
                                write(9,*) volume(c)**(0.33333)
                             end do
  write(9,'(A)') '        </DataArray>'

  write(9,'(A)') '        <DataArray type="Float32" Name="Ls" format="ascii">'
                             do c=1,NCsub
                                write(9,*) Ls % mean(c)
                             end do
  write(9,'(A)') '        </DataArray>'
  ...
  write(9,'(A)') '        <DataArray type="Float32" Name="VISt_mean" format="ascii">'
                             do c=1,NCsub
                                write(9,*) VISt_mean(c)
                             end do
  write(9,'(A)') '        </DataArray>'
...
!-- mean uu,vv,ww,uv,uw,vw stresses-------------------------------------------------------------------------------------------
  ...
  write(9,'(A)') '        <DataArray type="Float32" Name="Velocity2ndOrderCovarianceMean" NumberOfComponents="6" format="ascii">'
                              do c=1,NCsub
                     write(9,*) ( uu  % mean(c) ), &
                                ( vv  % mean(c) ), &
                                ( ww  % mean(c) ), &
...
!--vector: velocity
  write(9,'(A88)')'        <DataArray type="Float32" Name="velocity" NumberOfComponents="3" format="ascii">'
                             do c=1,NCsub
                                write(9,*) U % n(c), V % n(c), W % n(c) 
                             end do  
  write(9,'(A20)') '        </DataArray>'

  write(9,'(A103)') '        <DataArray type="Float32" Name="VelocityMeanAccumulated" NumberOfComponents="3" format="ascii">'
                             do c=1,NCsub
...
!     write(*,*) 'writing parallel master file: ', name
     ...
     !--scalar: k and eps
     write(12,'(A)') '        <PDataArray type="Float32" Name="Kin_mean"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="Eps_mean"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="LRANS"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="LSGS"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="Ls"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="Pressure"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="VISt_mean"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="Velocity2ndOrderCovarianceMean" NumberOfComponents="6"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="velocity" NumberOfComponents="3"/>'
     write(12,'(A)') '        <PDataArray type="Float32" Name="VelocityMeanAccumulated" NumberOfComponents="3"/>' 
