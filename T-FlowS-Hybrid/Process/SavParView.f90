...
if (SIMULA == HYB_ZETA) then
  ...
  write(9,'(A70)') '        <DataArray type="Float32" Name="VISt_sgs_mean" format="ascii">'
                             do c=1,NCsub
                                write(9,*) VISt_sgs_mean(c)
                             end do
  write(9,'(A20)') '        </DataArray>'
...
!=============================================================================================================================
if  ( ( SIMULA == LES ) .or. ( SIMULA == ZETA ) .or. ( SIMULA == HYB_ZETA ) )  then
...
!     write(*,*) 'writing parallel master file: ', name
     ...
     if ((SIMULA == K_EPS).or.(SIMULA == K_EPS_VV).or.(SIMULA == ZETA).or.(SIMULA==HYB_ZETA)) then
        ...
        !write(12,'(A49)') '        <PDataArray type="Float32" Name="alpha"/>'
        ...
        !write(12,'(A48)') '        <PDataArray type="Float32" Name="VISt"/>'
        write(12,'(A53)') '        <PDataArray type="Float32" Name="VISt_mean"/>'
        !write(12,'(A52)') '        <PDataArray type="Float32" Name="VISt_sgs"/>'
        write(12,'(A57)') '        <PDataArray type="Float32" Name="VISt_sgs_mean"/>'
        !write(12,'(A52)') '        <PDataArray type="Float32" Name="VISt_eff"/>'
        write(12,'(A57)') '        <PDataArray type="Float32" Name="VISt_eff_mean"/>'
