...
!------- ww stress
      ...
      Prod = -2.0*(uw % n(c)*Wx(c) + vw % n(c)*Wy(c))  &
...
!------- uv stress
      ...
      b(c) = b(c) + (Prod + (1.0-f22 % n(c)*f22 % n(c))*PHI_wall +&
             f22 % n(c)*f22 % n(c)*(PHI_hom))*volume(c)
      Aval(Adia(c)) =  Aval(Adia(c)) + (Vy(c)+Ux(c)+(1.0-f22%n(c)*f22%n(c))*&
                      6.0*Eps%n(c)/Kin%n(c)&
                    + f22%n(c)*f22%n(c)*( &
...
!------- uw stress
      ...
      b(c) = b(c) + (Prod + (1.0-f22 % n(c)*f22 % n(c))*PHI_wall +&
             f22 % n(c)*f22 % n(c)*(PHI_hom))*volume(c)
      Aval(Adia(c)) =  Aval(Adia(c)) + (Wz(c)+Ux(c)+(1.0-f22%n(c)*f22%n(c))*&
                      6.0*Eps%n(c)/Kin%n(c)&           
                    + f22%n(c)*f22%n(c)*(&
                    +g1*Eps%n(c)/(2.0*Kin%n(c))+g1_star*Pk(c)/(2.0*Kin%n(c))))*volume(c)
...
!------- vw stress
      ...
      b(c) = b(c) + (Prod + (1.0-f22 % n(c)*f22 % n(c))*PHI_wall +&
             f22 % n(c)*f22 % n(c)*(PHI_hom))*volume(c)
      Aval(Adia(c)) =  Aval(Adia(c)) + (Wz(c)+Vy(c)+(1.0-f22%n(c)*f22%n(c))*&
                      6.0*Eps%n(c)/Kin%n(c) &           
                    + f22%n(c)*f22%n(c)*(&
                    +g1*Eps%n(c)/(2.0*Kin%n(c))+g1_star*Pk(c)/(2.0*Kin%n(c))))*volume(c)
!------- Eps eq.
